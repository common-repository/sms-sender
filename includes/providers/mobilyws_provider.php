 ...
 * mobily.ws API Class
 *
 * connect to mobily.ws API.
 *
 * @class       MobilywsProvider
 * @version     0.1
 * @author      smsgw.net
 */

class MobilywsProvider implements ProviderInterface{
    ...
    public static function SendSMS($mobiles, $message) {
        ...
        $post = [
                'mobile'            => get_option('smsgwnet_api_user'), 
                'password'          => get_option('smsgwnet_api_pass'), 
                'sender'            => urlencode(get_option('smsgwnet_api_tag')),  
                'numbers'           => implode(',', $mobiles), 
                'msg'               => MobilywsProvider::convertToUnicode($message),
                'timeSend'          => '0',
                'dateSend'          => '0',
                'applicationType'   => '24',
                'deleteKey'         => '0',
    ...
    public static function GetBalance() {
        $api_url = 'http://www.mobily.ws/api/balance.php';
        $post = [
                'mobile'    => get_option('smsgwnet_api_user'), 
                'password'  => get_option('smsgwnet_api_pass'), 
            ];
