<?php
/**
 * malath.net.sa API Class
 *
 * connect to malath.net.sa API.
 *
 * @class       MalathnetProvider
 * @version     0.1
 * @author      smsgw.net
 */

class MalathnetProvider implements ProviderInterface{
    ...
    public static function SendSMS($mobiles, $message) {
        $api_url = 'http://sms.malath.net.sa/httpSmsProvider.aspx';
        $post = [
                ...
                'message'   => MalathnetProvider::convertToUnicode($message), 
                'encoding'  => 'U',
            ];
    ...
    public static function GetBalance() {
        $api_url = 'http://sms.malath.net.sa/api/getBalance.aspx';
        $post = [
     ...
     *
     * return Unicode string for message
     *
     * @access public
